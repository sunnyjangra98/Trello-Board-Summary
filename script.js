...
function parseData(){
    ...
    //     });
    // });
    var str = `<div style="margin-left:2%"><p style="font-size:20px">No. Of Cards : <b>${cards.size}</b></p>
    <input type="button" id="btnExport" class="btn btn-success" value="Export Cards to Excel" onclick="Export('cardsTable', 'Trello-Board-Cards')" />
    <p style="font-size:18px">Cards:-</p></div>
    <div style="customStyle"><table class="table table-bordered" id="cardsTable"><tr>
    <th>S.No.</th>
    <th>Card Name</th>
    <th>Current List</th>
    <th>Description</th>
...
function Export(tableId, filename='Table') {
